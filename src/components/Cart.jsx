          ...
          <div className="q-card-price w_750_px">
            <div className="shipping-card-left">
              ...
              <div className="counter">
                <button className="counter-btn decrement" onClick={() => removeProductFromCart(product.id)}>&ndash;</button>
                <span className="counter-value">{product.count}</span>
                <button className="counter-btn increment"  onClick={() => addProductToCart(product)}>+</button>
              </div>
            </div>
            <div className="card-body justify-end text-primary">
              <div className="card-info-shipping">
                ...
                <div className="self-start">
                  ...
                  <span className="price shipping-price">{product.discount} &#8381;</span>
                </div>
                <div className="self-end price-total">{product.price} &#8381;</div>
              </div>
            </div>
          </div>
        ))}
